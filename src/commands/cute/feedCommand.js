...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        try {
            ...
            .setDescription(`${message.author} gave food to ${membro}`)
            .setColor('DarkerGrey')
            .setImage((await nekos.feed()).url)
                ...
                collector.on('collect', async (i) => {
                    ...
                    if (i.customId === 'feedGaveBack') {
                        ...
                        i.reply({
                            ...
                            embeds: [
                                new EmbedBuilder()
                                    .setDescription(`${membro} gave food to ${message.author}`)
                                    .setColor('DarkerGrey')
                                    .setImage((await nekos.feed()).url)
