...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        try {
            ...
            embed
            .setDescription(`${message.author} kissed ${membro}`)
            .setColor('DarkerGrey')
            .setImage((await nekos.kiss()).url)
                ...
                collector.on('collect', async (i) => {
                    ...
                    if (i.customId === 'kissGaveBack') {
                        ...
                        i.reply({
                            ...
                            embeds: [
                                new EmbedBuilder()
                                    .setDescription(`${membro} kissed ${message.author}`)
                                    .setColor('DarkerGrey')
                                    .setImage((await nekos.kiss()).url)
